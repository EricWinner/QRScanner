...
public class QCFragmentAdapter extends FragmentPagerAdapter {
    protected static final String[] CONTENT = new String[]{"This", "Is", "A", "Test",};

    private int mCount = CONTENT.length;

    public QCFragmentAdapter(FragmentManager fm) {
        super(fm);
    }
    ...
    public CharSequence getPageTitle(int position) {
        return QCFragmentAdapter.CONTENT[position % CONTENT.length];
    }
